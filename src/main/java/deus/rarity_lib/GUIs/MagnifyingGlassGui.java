...
public class MagnifyingGlassGui extends GuiContainer {


	private IInventory inventory;
	private final int inventoryRows;

	public MagnifyingGlassGui(IInventory iinventory,IInventory iinventory1) {
